...
export const products: ProductItem[] = [
  {
    id: 'prod_invite_royal',
    category: 'invitations',
    name: 'Royal Gold Foil Invitation',
    seller: 'Patna Print House',
    city: 'Patna',
    price: { minorUnits: 12000, currency: 'INR', unit: 'per card' },
    rating: 4.8,
    reviewCount: 64,
    image: { id: 'p1', url: img('1607344645866-009c320b63e0'), alt: 'Gold foil wedding invitation card', order: 0 },
    description: 'Hand-finished gold foil invitations on premium textured stock. Minimum order 100 cards.',
  },
  {
    id: 'prod_lehenga_bridal',
    category: 'wedding_wear',
    name: 'Hand-embroidered Bridal Lehenga',
    seller: 'Rivaaj Couture',
    city: 'Patna',
    price: { minorUnits: 8500000, currency: 'INR', unit: 'per piece' },
    rating: 4.9,
    reviewCount: 41,
    image: { id: 'p2', url: img('1610030469983-98e550d6193c'), alt: 'Red bridal lehenga with embroidery', order: 0 },
    description: 'Custom-tailored bridal lehenga with zardozi hand embroidery. 4–6 week lead time.',
  },
  {
    id: 'prod_polki_set',
    category: 'jewellery',
    name: 'Polki Bridal Jewellery Set',
    seller: 'Sona Jewellers',
    city: 'Patna',
    price: { minorUnits: 12500000, currency: 'INR', unit: 'per set' },
    rating: 4.7,
    reviewCount: 28,
    image: { id: 'p3', url: img('1611591437281-460bfbe1220a'), alt: 'Polki bridal necklace set', order: 0 },
    description: 'Uncut polki necklace, earrings and maang tikka. Hallmarked, with certificate.',
  },
  {
    id: 'prod_hamper_lux',
    category: 'gifting',
    ...
    seller: 'Shagun Boxes',
    city: 'Patna',
    price: { minorUnits: 250000, currency: 'INR', unit: 'per hamper' },
    rating: 4.6,
    reviewCount: 112,
    image: { id: 'p4', url: img('1549465220-1a8b9238cd48'), alt: 'Decorated wedding gift hamper', order: 0 },
    description: 'Curated dry-fruit and sweets hampers with custom ribboning. Bulk pricing available.',
  },
  {
    id: 'prod_cake_tier',
    category: 'cakes',
    name: 'Three-tier Wedding Cake',
    seller: 'Sugar & Spice Bakers',
    city: 'Patna',
    price: { minorUnits: 800000, currency: 'INR', unit: 'per cake' },
    rating: 4.8,
    reviewCount: 76,
    image: { id: 'p5', url: img('1535141192574-5d4897c12636'), alt: 'Three tier white wedding cake', order: 0 },
    description: 'Customisable three-tier fondant cake with fresh-flower finish. Eggless option available.',
  },
  {
    id: 'prod_favours_mini',
    category: 'favours',
    name: 'Personalised Guest Favours',
    seller: 'Little Tokens',
    city: 'Patna',
    price: { minorUnits: 15000, currency: 'INR', unit: 'per favour' },
    rating: 4.7,
    reviewCount: 53,
    image: { id: 'p6', url: img('1519225421980-715cb0215aed'), alt: 'Wedding guest favour boxes', order: 0 },
    description: 'Personalised mini favours — candles, chocolates or potli bags. Minimum 50 units.',
  },
]
