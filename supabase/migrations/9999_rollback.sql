...
drop table if exists remote_config, device_tokens, reviews, bookings, messages,
  conversations, enquiries, favourites, availability, packages, media, listings,
  vendor_members, vendors, profiles cascade;

drop type if exists message_state, booking_status, enquiry_stage, listing_status,
  approval_status, vendor_category, role;
